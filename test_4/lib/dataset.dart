...
class Weather {
  ...
  Weather(this.max, this.min, this.current, this.name, this.day, this.wind, this.humidity, this.chanceRain, this.image, this.time, this.location, );
  //get appid from http://openweathermap.org
String appId = "9f3c524a7b5c7ae5930ad1eba70ebe97";
...
Future<List> fetchData(String lat,String lon,String city) async{
  var url = "https://api.openweathermap.org/data/2.5/lat=$lat&lon=$lon&units=metric&appid=$appId";
